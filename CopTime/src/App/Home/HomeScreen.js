...
import { View, Text, StyleSheet, Dimensions, TouchableNativeFeedback, StatusBar, PermissionsAndroid, ImageBackground, ToastAndroid } from 'react-native'
...
export default class HomeScreen extends Component {
    ...
    componentDidMount() {
        ...
        // this.requestCameraPermission(currentComponent)
        ...
        // emergency = new Sound('https://raw.githubusercontent.com/zmxv/react-native-sound-demo/master/advertising.mp3', null, (error) => {
        //     if (error) {
        //         console.warn('failed to load the sound', error);
        //         return;
        //     }
        //     // loaded successfully
        //     console.warn('duration in seconds: ' + emergency.getDuration() + 'number of channels: ' + emergency.getNumberOfChannels());
        // }
        // )
    }
            ...
            <View style={styles.lowerHome} >
                <ScrollView >
                    <View style={styles.Help} elevation={1} >
                        <TouchableNativeFeedback onPress={() => { this.props.navigation.navigate('SOS', { firstTime: true, sos: true, latitude: latitude, longitude: longitude }) }} style={styles.touchableHelp}>
